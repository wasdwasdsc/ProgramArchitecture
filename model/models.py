...
import datetime, trace

petrol_price = {"Ai92": 19.5, "Ai95": 20.8, "Ai98": 22.3}
charge_of_gasoline = {"car1": 6.5, "car2": 9, "car3": 17}
expense_accounting = {}
...
def add_record(car, petrol, distance):
    ...
    if car not in charge_of_gasoline or petrol not in petrol_price:
        return False
